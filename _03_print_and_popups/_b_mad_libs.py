...
if __name__ == '__main__':
    ...
    window_2.withdraw()
    # Put this sentence in a pop-up message box:"If you find yourself having to cross a piranha-infested river, here's how to do it..."
    messagebox.showinfo(message="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adjective= simpledialog.askstring(title='enter a adjective', prompt="")
    # Get the player to enter a type of liquid
    liquid= simpledialog.askstring(title='enter a liquid', prompt="")
    # Get the player to enter a body part
    bp= simpledialog.askstring(title='enter a body part', prompt="")
    # Get the player to enter a verb
    verb= simpledialog.askstring(title='enter a verb', prompt="")
    # Get the player to enter a place
    place= simpledialog.askstring(title='enter a place', prompt="")
